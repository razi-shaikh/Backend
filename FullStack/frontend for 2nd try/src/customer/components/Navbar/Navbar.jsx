...
export default function Navbar() {
  ...
  const handelCategory = (category, section, item) => {
                        ...
                        >
                          {section.items.map((item) => (
                            <li key={item.name} className="flow-root">
                              <p href={item.href} className="-m-2 block p-2 text-gray-500"
                                onClick={() => {
                                  handelCategory(category.id, section.id, item.name)
                                }}>
                                {item.name}
                              </p>
                            </li>
            ...
            <div className="flex h-16 items-center">
              ...
              <div className="ml-auto flex items-center">
                <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                  ...
                  <span aria-hidden="true" className="h-6 w-px bg-gray-200 border-r" />
                  <a href="#" className="text-sm font-medium text-gray-700 hover:text-gray-800">
                    Create account
                  </a>
                </div>
